...
cp "$ROOT_DIR/swift/Resources/speakex-menubar.png" "$STAGE_APP/Contents/Resources/"
cp "$ROOT_DIR/swift/Resources/speakex-menubar@2x.png" "$STAGE_APP/Contents/Resources/"
